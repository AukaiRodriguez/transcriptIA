export const translations = {
  es: {
    ...
    auth_signup_subtitle: 'Empieza a transcribir tus reuniones en minutos.',
    auth_signin_subtitle: 'Bienvenido de nuevo. Ingresa tus datos para continuar.',
    auth_email: 'Email',
    ...
    // Auth hero panel (features destacadas)
    auth_feature_1: 'Transcripción precisa con IA',
    auth_feature_2: 'Resúmenes ejecutivos automáticos',
    auth_feature_3: 'Exporta a PDF al instante',
    ...
    home_subtitle: 'Presiona el micrófono para comenzar la transcripción',
    ...
    analyzing_transcribe_title: 'Transcribiendo audio...',
    analyzing_transcribe_subtitle: 'Mejorando la precisión de la transcripción antes de analizar. Un momento.',
    ...
    // Transcribe service errors (transcribe.js — ElevenLabs Scribe v2)
    err_transcribe_no_key: 'API Key de ElevenLabs no configurada o inválida (VITE_ELEVENLABS_API_KEY). La transcripción precisa está deshabilitada; se usó la transcripción en vivo del navegador.',
    err_transcribe_empty: 'No se capturó audio para transcribir.',
    err_transcribe_too_large: 'El archivo de audio es demasiado grande para transcribir.',
    err_transcribe_network: 'No se pudo conectar con el servicio de transcripción. Revisa tu conexión a internet.',
    err_transcribe_rate_limit: 'Se alcanzó el límite de peticiones del servicio de transcripción. Espera un momento e intenta de nuevo.',
    err_transcribe_provider: 'Error del servicio de transcripción: {detail}',
    err_transcribe_empty_result: 'El servicio de transcripción no devolvió texto.',
  ...
  en: {
    ...
    auth_signup_subtitle: 'Start transcribing your meetings in minutes.',
    auth_signin_subtitle: 'Welcome back. Enter your details to continue.',
    auth_email: 'Email',
    ...
    // Auth hero panel (highlighted features)
    auth_feature_1: 'Accurate AI-powered transcription',
    auth_feature_2: 'Automatic executive summaries',
    auth_feature_3: 'Export to PDF instantly',
    ...
    home_subtitle: 'Press the microphone to start transcribing',
    ...
    analyzing_transcribe_title: 'Transcribing audio...',
    analyzing_transcribe_subtitle: 'Improving transcription accuracy before analyzing. One moment.',
    ...
    // Transcribe service errors (transcribe.js — ElevenLabs Scribe v2)
    err_transcribe_no_key: 'ElevenLabs API Key not configured or invalid (VITE_ELEVENLABS_API_KEY). Accurate transcription is disabled; the live browser transcription was used instead.',
    err_transcribe_empty: 'No audio was captured to transcribe.',
    err_transcribe_too_large: 'The audio file is too large to transcribe.',
    err_transcribe_network: 'Could not connect to the transcription service. Check your internet connection.',
    err_transcribe_rate_limit: 'The transcription service request limit was reached. Wait a moment and try again.',
    err_transcribe_provider: 'Transcription service error: {detail}',
    err_transcribe_empty_result: 'The transcription service did not return any text.',
